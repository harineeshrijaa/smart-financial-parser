...
def main(argv=None):
    ...
    p.add_argument("--output", "-o", default=None, help="Optional path to write cleaned CSV")
    p.add_argument("--report", "-r", default=None, help="Optional path to write report JSON")
